...
const TimelineSection = () => {
  return (
    <div>
      <div className="flex flex-collg:flex-row gap-20 mb-20 items-center">
        <div className="lg:w-[45%] flex flex-col gap-14 lg:gap-3">
          {timeline.map((element, index) => {
            return (
              <div className="flex flex-col lg:gap-3 " key={index}>
                <div className="w-[52px] h-[52px] bg-white flex justify-center items-center shadow-[#00000012] shadow-[0_0_62px_0]">
