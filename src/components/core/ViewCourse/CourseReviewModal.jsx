...
const CourseReviewModal = ({ setReviewModal }) => {
  ...
  //jab bhi useForm ko us ekaro ye krma toh compulsory hai hi
  const {
    register,
    handleSubmit,
    setValue,
  ...
  //initial values rakhlo modal ki toh set on first render
  useEffect(() => {
  ...
  const onSubmit = async (data) => {
    ...
    setReviewModal(false); //Modal ko close kr dena after successfull submission of Review
  };
